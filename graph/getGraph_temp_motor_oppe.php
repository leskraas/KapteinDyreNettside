...
$result_temp = $abs->query('SELECT * FROM (SELECT id, FROM_UNIXTIME(timestamp) as timestamp,temp_motor_oppe FROM baat ORDER BY id DESC LIMIT 300) a ORDER BY id ASC');
