...
$result_temp = $abs->query('SELECT * FROM (SELECT id, FROM_UNIXTIME(timestamp) as timestamp,temp_motor_nede,temp_motor_oppe,temp_lugar,temp_rom_bak,temp_vann FROM baat ORDER BY id DESC LIMIT 300) a ORDER BY id ASC');
