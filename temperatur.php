...
<head>
    ...
    include 'graph/getGraph_temperatur.php';
    ?>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-menubuilder">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="temperatur.php" data-toggle="tooltip" title="Temperatur"><img src="Bilder/temp1.png" style="width: 33px" alt="Temperatur"></a></li>
